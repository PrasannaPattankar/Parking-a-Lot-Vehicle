		...
		return (
			<div className="entry-block">
				<div className="row">
					...
					<label className="col-4"><span className="col-6">Initial Vehicles </span><input type="number" className="col-6" name="filled" onChange={this.changeHandler} value={this.props.filled } /></label>
