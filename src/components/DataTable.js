...
//filter by color & Registration Number and Slots Avialable
const Filters = (props) => {
	return (
			<div className="row filters">
				<div className="col-4"><input type="text" name="regfilter" placeholder="Enter Registration Number" onChange={props.onChange} value={props.filterVals.rfil}/></div>
				<div className="col-4"><input type="text" name="colorfilter" placeholder="Color" onChange={props.onChange} value={props.filterVals.cfil}/></div>
				<div className="col-2"><input type="number" name="slotfilter" placeholder="Slot Allocation" onChange={props.onChange} value={props.filterVals.sfil}/></div>
